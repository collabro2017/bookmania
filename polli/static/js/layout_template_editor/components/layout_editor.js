        ...
        return (
            <div className="form-section">
                ...
                <div className="form-field language-select">
                    <label>Text</label>
                    <textarea className="no-header" onChange={this.updateText} onBlur={this.props.onSavePage} value={this.getLanguageText()}></textarea>
                </div>
...
class LayoutEditor extends React.Component {
    ...
    render() {
        ...
        if(this.props.activeElement && this.props.activeElement.type=='text'){
            settings = <TextSettings onSavePage={this.props.savePage} onUpdateText={this.updateText} language={this.props.language} element={this.props.activeElement} onUpdateElementProperty={this.updateElementProperty}/>
        }else if(this.props.activeElement && this.props.activeElement.type=='image'){
            settings = <ImageSettings index={this.props.activeElementIndex} element={this.props.activeElement} onUpdateContainerProperty={this.updateContainerProperty} pageStyle={this.props.style}/>
        }
...
const layoutEditorStateMap = (state) => {
    return {
        style: state.LayoutTemplateEditorReducer.style,
        elements: state.LayoutTemplateEditorReducer.elements,
        language: state.LayoutTemplateEditorReducer.language,
        activeElement: state.LayoutTemplateEditorReducer.activeElement,
        activeElementIndex: state.LayoutTemplateEditorReducer.activeElementIndex
    }
}
